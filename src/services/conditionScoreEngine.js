...
class ConditionScoreEngine {
   ...
   *
   * 【高温時】
   * 15℃～20℃: 100 - (temp - 15) × 4 → 20℃で80点
   * 20℃～25℃: 80 - (temp - 20) × 8 → 25℃で40点
   * 25℃～30℃: 40 - (temp - 25) × 4 → 30℃で20点
   * 30℃～35℃: 20 - (temp - 30) × 4 → 35℃で0点
   * 35℃以上: 0点
   */
  calculateTemperatureScore(temp) {
    ...
    // 高温時: 15℃～20℃
    if (temp > 15 && temp <= 20) {
      // 15℃=100点, 20℃=80点 → 5℃で20点低下
      return 100 - (temp - 15) * 4;
    }

    // 高温時: 20℃～25℃
    if (temp > 20 && temp <= 25) {
      // 20℃=80点, 25℃=40点 → 5℃で40点低下
      return 80 - (temp - 20) * 8;
    }

    // 高温時: 25℃～30℃
    if (temp > 25 && temp <= 30) {
      // 25℃=40点, 30℃=20点 → 5℃で20点低下
      return 40 - (temp - 25) * 4;
    }

    // 高温時: 30℃～35℃
    if (temp > 30 && temp <= 35) {
      // 30℃=20点, 35℃=0点 → 5℃で20点低下
      return 20 - (temp - 30) * 4;
    }
